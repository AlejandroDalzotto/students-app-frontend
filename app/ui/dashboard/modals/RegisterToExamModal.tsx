        ...
        <article>
          <form action={(d) => {
            ...
            <fieldset>
              ...
              <Input name="exam_key" type="text" placeholder="Primer examen lengua II" label="Nombre del examen" required />
              <Input name="grade" type="number" placeholder="7, 10, 9.5, 0" label="Nota del alumno" required />
            </fieldset>
            ...
            <fieldset>
              ...
              <div className="inline-block relative w-full mb-5">
                <select name="state" id='select-state-student' className="block appearance-none w-full bg-transparent border border-neutral-400 hover:border-neutral-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                  <option value="" disabled selected>Selecciona el estado del alumno</option>
