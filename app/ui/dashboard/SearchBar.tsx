...
export default function SearchBar({label, placeholder}: Props) {
  ...
  return (
    <div className="relative h-full w-full max-w-md">
      <input type="text" placeholder={placeholder}
        ...
        autoComplete="off"
        className="peer h-full w-full text-xl pb-3 text-neutral-900 dark:text-white border-b border-neutral-200 bg-transparent pt-4 font-normal outline outline-0 transition-all placeholder-shown:border-neutral-300 focus:border-neutral-500 focus:outline-0 disabled:border-0 disabled:bg-neutral-50 placeholder:opacity-0 focus:placeholder:opacity-100" />
      <label
        htmlFor="search-bar"
