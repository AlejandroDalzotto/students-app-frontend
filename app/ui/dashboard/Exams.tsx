        ...
        exams.map(({ key, module, subject, date }) => {
          return (
            <Link
              ...
              className="group/box grid items-center grid-cols-4 py-4 px-12 w-full border rounded-lg shadow dark:border-neutral-700 transition-colors dark:hover:border-neutral-400"
              key={key + date}>
